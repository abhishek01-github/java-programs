...
public class C_Turtle_Fingers_Count_the_Values_of_k {
    ...
    private static void solve(int t) {
        ...
        while(l%((int)Math.pow(a,x))==0 || l%((int)Math.pow(b,y))==0){
            if(l%((int)Math.pow(a,x))==0) {
                ans.add(l/((int)Math.pow(a,x)));
                x++;
            }
            if(l%((int)Math.pow(b,y))==0) {
                ans.add(l/(int)Math.pow(b,y));
                y++;
            }
        }
        ...
        while(x>0){
            for (int i = 1; i <= y; i++) {
                if(l%((int)Math.pow(a,x)*(int)Math.pow(b,i))==0){
                    ans.add(l/((int)Math.pow(a,x)*(int)Math.pow(b,i)));
                } else{
                    break;
                }
            }
